...
# モデルID
MODEL_ID = "https://65ee-34-16-178-224.ngrok-free.app"
...
def lambda_handler(event, context):
    try:
        ...
        url = "https://65ee-34-16-178-224.ngrok-free.app/generate"
        # 送信するデータ（辞書形式）
        data = {
            "prompt": message,
            "max_new_tokens": 512,
        ...
        print(
            "Calling Bedrock Fast API with payload:",
            json.dumps(data),
        )

        # Requestオブジェクトを作成してPOSTとして送信
